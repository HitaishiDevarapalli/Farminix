      ...
      <div className="relative bg-white rounded-3xl max-w-xl w-full p-6 shadow-2xl z-10 animate-in zoom-in-95 duration-200 border border-gray-100 max-h-[90vh] overflow-y-auto">
        ...
        {cart.length === 0 ? (
          <div className="py-12 text-center space-y-4">
            <div className="w-16 h-16 rounded-full bg-purple-50 text-purple-600 flex items-center justify-center mx-auto text-2xl font-black">
              🛒
            </div>
            ...
            <button
              onClick={() => setIsCheckoutOpen(false)}
              className="px-6 py-2.5 bg-purple-600 hover:bg-purple-700 text-white text-xs font-bold rounded-xl shadow-md transition-colors cursor-pointer"
            >
              Explore Products
            </button>
          </div>
